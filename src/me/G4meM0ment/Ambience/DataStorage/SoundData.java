package me.G4meM0ment.Ambience.DataStorage;
...
public class SoundData {
	...
	private static String defConfig = "soundDataFileExample.yml";
	private static String logTit;
	
	private static String dir;

	public SoundData(Ambience subplugin) {
		this.subplugin = subplugin;
		
		dir = subplugin.getDir();
		logTit = subplugin.getLogTit();
		configFile = new File(dir+"/sounds.yml");
	}
